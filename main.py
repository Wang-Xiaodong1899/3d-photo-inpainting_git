...
from utils import get_MiDaS_samples, read_MiDaS_depth, get_MiDaS_samples_Real, get_MiDaS_samples_MC
import torch
import cv2
    ...
    if idx<0:
        ...
        try:
            ...
            if config['use_boostmonodepth'] is True:
                run_boostmonodepth(sample['ref_img_fi'], sample['depth_fi'], config['src_folder'], config['depth_folder'])
