...
def run_boostmonodepth(img_names, depth_names, src_folder, depth_folder):
    ...
    for (i,img_name) in enumerate(img_names):
        ...
        # tgt_names.append(tgt_name.replace('.jpg', '.png'))
    ...
    for i, (img_name, tgt_name) in enumerate(zip(img_names, tgt_names)):
        ...
        tgt_name = os.path.basename(depth_names).split('.')[0]+'.png'
